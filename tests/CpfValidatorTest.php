...
{
$this->assertTrue(CpfValidator::validate('02663322008')); // Exemplo de CPF válido
}
...
{
$this->assertFalse(CpfValidator::validate('1234567890')); // Exemplo de CPF com
//comprimento inválido
}

public function testCpfWithNonNumericCharacters()
{
$this->assertTrue(CpfValidator::validate('123.456.789-09')); // Exemplo de CPF válido
//com caracteres não numéricos
}
public function testKnownInvalidCpf()
{
$this->assertFalse(CpfValidator::validate('11111111111')); // Exemplo de CPF conhecido
//como inválido
}
}